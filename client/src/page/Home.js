        ...
        <InnerWrapperBox2>
          <div class="icons-circles-texts">
            <div>
              ...
              <p>Join a supportive community of millions of coders</p>
            </div>
            <div>
              <Circle>
                <CertificateIcon width="1.5em" height="1.5em" color="#fff" />
              </Circle>
              <p>Build projects and earn free certifications.</p>
            </div>
            <div>
              <Circle>
                <ExperienceIcon width="1.5em" height="1.5em" color="#fff" />
              </Circle>
              <p>Get experience by coding for nonprofits.</p>
            </div>
          </div>
        ...
        <div>
            <div className="text-section">
                ...
                <div>
                    ...
                    We walk, talk, live, breathe, eat and die.
                </div>
            </div>
